...
/// the very face this file animates.
public enum AvatarArtwork {
    ...
    /// to display a 160×160 PNG — parking that still on the row would replace
    /// the animated face with a photograph of itself.
    ///
    ...
    /// that trusts `has_avatar` alone shows five frozen faces and none of this
    /// file's motion ever appears. Any client that both uploads and downloads
    /// profile avatars needs this guard or its bots slowly freeze into stills.
